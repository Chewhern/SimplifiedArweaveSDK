...
**Important: As the HTTP API endpoint is using arweave.net, the developer will be required to check the submission status of transaction via viewblock (https://viewblock.io/arweave/address/{Arweave_Wallet_Address} for better confirmation..**
