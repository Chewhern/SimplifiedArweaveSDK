...
namespace SimplifiedArweaveSDK.RSAPSSHelper
{
    ...
    {
        public static Byte[] SignData(Byte[] Data, Byte[] ModulusBytes, Byte[] ExponentBytes, Byte[] DBytes, Byte[] PBytes, Byte[] QBytes, Byte[] DPBytes, Byte[] DQBytes, Byte[] InverseQBytes, Boolean ClearKey=false) 
        {
