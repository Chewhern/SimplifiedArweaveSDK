...
namespace SimplifiedArweaveSDK.ArweaveLocalHelper
{
    ...
    {
        public static async Task<(String Status,String TransactionID)> UploadData(Object Data,String OwnerRSAModulusString, Byte[] ModulusBytes, Byte[] ExponentBytes, Byte[] DBytes, Byte[] PBytes, Byte[] QBytes, Byte[] DPBytes, Byte[] DQBytes, Byte[] InverseQBytes, Boolean ClearKey=false) 
        {
            ...
            Byte[] SignatureData = CurrentRSAOpsHelper.SignData(DeepHashResult, ModulusBytes, ExponentBytes, DBytes, PBytes, QBytes, DPBytes, DQBytes, InverseQBytes,ClearKey);
            ...
            (String Status, String TransactionID) MyResults = new("", "");
            MyResults.Status = await UploadDataHelper.UploadData(JsonConvert.SerializeObject(MyTransaction));
            MyResults.TransactionID = MyTransaction.id;
            return MyResults;
        }
