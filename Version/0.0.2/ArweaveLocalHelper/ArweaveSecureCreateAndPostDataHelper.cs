...
namespace SimplifiedArweaveSDK.ArweaveLocalHelper
{
    ...
    {
        public static async Task<(String Status,String TransactionID)> UploadData(Object Data,String OwnerRSAModulusString, Byte[] ModulusBytes, Byte[] ExponentBytes, Byte[] DBytes, Byte[] PBytes, Byte[] QBytes, Byte[] DPBytes, Byte[] DQBytes, Byte[] InverseQBytes) 
        {
